			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav">
					<li class="nav-item active"><a class="nav-link"
						href="listerCollaborateur.jsp">Collaborateurs <span
			...
			<form class="needs-validation"
				...
				<div class="form-group row">
					...
					<div class="col-md-6">
						...
						<div class="invalid-feedback">Entrer la date de naissance.</div>
					</div>
				</div>
				...
				<div class="form-group row">
					<label for="secu" class="col-md-6 col-form-label">Numéro de
						sécurité sociale</label>
					<div class="col-md-6">
						<input type="text" class="form-control" id="secu" name="secu"
							required>
						<div class="invalid-feedback">Entrer le numéro de sécurité
							sociale.</div>
					</div>
				</div>
					...
					<div class="modal-dialog modal-dialog-centered" role="document">
						<div class="modal-content">
							...
							<div class="modal-footer">
								...
								<button onclick="document.forms[0].submit();" type="button"
